  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          getTranslate(context, 'recommended.recommended_you'),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    width5Space,
                    Text(
                      recommendedList[index]['rate'].toString(),
                ...
                Row(
                  children: [
                    ...
                    width5Space,
                    Text(
                      recommendedList[index]['view'].toString(),
                      style: regular14Black2,
                      overflow: TextOverflow.ellipsis,
                    )
                  ],
            ...
            Text(
              recommendedList[index]['author'].toString(),
