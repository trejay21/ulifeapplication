...
class NewReleaseScreen extends StatelessWidget {
  NewReleaseScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          getTranslate(context, 'new_release.new_release'),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage(
                      newreleaseList[index]['image'].toString(),
                    ),
                    fit: BoxFit.cover,
                  ),
                ),
            ...
            height5Space,
            Text(
              newreleaseList[index]['name'].toString(),
              style: bold15Black2,
              ...
              children: [
                Row(
                  children: [
                    ...
                    width5Space,
                    Text(
                      newreleaseList[index]['rate'].toString(),
                ...
                Row(
                  children: [
                    ...
                    width5Space,
                    Text(
                      newreleaseList[index]['view'].toString(),
                      style: regular14Black2,
                      overflow: TextOverflow.ellipsis,
                    )
                  ],
            ...
            Text(
              newreleaseList[index]['author'].toString(),
